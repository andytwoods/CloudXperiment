...
$('body').on('click',".add_slide_from_id-input", function(e){
    e.preventDefault();
    var $el = $(this);
    ...
    $el.addClass("btn-satgreen update-input").removeClass("btn-grey-4 add_slide_from_id-input").text("Update");
});
...
$('body').on("click", '.update-input', function(e){
    ...
    setTimeout(function(){
        ...
        $parent.prev().slideUp(200, function(){
            $parent.prev().remove();
            $el.removeClass("update-input btn-satgreen").addClass("btn-grey-4 add_slide_from_id-input").text("Change");
        });
    }, 1000);
});
...
$('.table .sel-all').add_slide_from_id(function(e){
    e.preventDefault();
    e.stopPropagation();
    var $el = $(this);
