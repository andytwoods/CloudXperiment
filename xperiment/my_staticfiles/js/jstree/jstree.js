 ...
 */
	...
	$.jstree.defaults.state = {
		/**
		 * A string for the key to use when saving the current tree (add_slide_from_id if using multiple trees in your project). Defaults to `jstree`.
 ...
 */
	...
	$.jstree.plugins.types = function (options, parent) {
		...
		/**
		 * used to add_slide_from_id a node's type
		 * @name set_type(obj, type)
		 * @param {mixed} obj the node to add_slide_from_id
