...
urlpatterns = [
    ...
    url(r'^experiment/(?P<expt_id>\w+)/results/$', views.see_results, name='see_results'),
    ...
    url(r'^experiment/(?P<expt_id>\w+)/(?P<type>\w+)/download_zip/$', views.download_zip, name='download_zip'),
    ...
    url(r'^(?P<lab_id>\d+)/experiment/create/$', views.create, name='create'),
    ...
    url(r'^experiment/(?P<expt_id>\w+)/(?P<uuid>\w+)/data/$', views.data, name='data'),
]
